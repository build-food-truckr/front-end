...
useEffect(()=>{
    if(props.truck.categories[0]){
        const icon = props.truck.categories[0].icon
        // console.log(icon)
...
// Example: https://igx.4sqi.net/img/general/300x500/5163668_xXFcZo7sU8aa1ZMhiQ2kIP7NllD48m7qsSwr1mJnFj4.jpg
    ...
    return (
        <div className="card">
            <img className="icon" src={newImage} alt="truck-icon"/>
            <div className="info">
                <h2>{props.truck.name}</h2>
                <h4>{props.truck.location.formattedAddress[0]}</h4>
            </div>
            <style jsx>{`
      .container {
        min-height: 100vh;
